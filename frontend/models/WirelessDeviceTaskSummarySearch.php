...
/**
 * WirelessDeviceTaskSummarySearch represents the model behind the search form about `frontend\models\WirelessDeviceTaskSummary`.
 */
class WirelessDeviceTaskSummarySearch extends WirelessDeviceTaskSummary
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = WirelessDeviceTaskSummary::find();
