...
/**
 * WirelessDeviceAlarmSearch represents the model behind the search form about `app\models\WirelessDeviceAlarm`.
 */
class WirelessDeviceAlarmSearch extends WirelessDeviceAlarm
{
    /**
     * @inheritdoc
     */
