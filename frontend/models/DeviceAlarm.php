...
class DeviceAlarm extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'alarmLevelDesc' => Yii::t('app', 'Alarm Level Desc'),
            'alarmCategory' => Yii::t('app', 'Alarm Category'),
            'alarmCategoryDesc' => Yii::t('app', 'Alarm Category Desc'),
            'faultTime' => Yii::t('app', 'Fault Time'),
            'faultTimeDesc' => Yii::t('app', 'Fault Time Desc'),
            'recTime' => Yii::t('app', 'Rec Time'),
            'recTimeDesc' => Yii::t('app', 'Rec Time Desc'),
